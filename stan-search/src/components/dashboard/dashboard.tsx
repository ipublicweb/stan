...
import { APARTMENT_SEARCH_MANAGER } from "../../services/api/apartment-search/apartment-search-manager";
...
export const Dashboard = function DashboardComponent(props: DashboardProps) {
    ...
    const onSearch = () => {
        APARTMENT_SEARCH_MANAGER.findApartments(APARTMENT_SEARCH_PARAMS)
            .then(result => {
